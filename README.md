...
#### 클래스 다이어그램 초안, 차후 개발 중 변경 가능성 높음

<img width="1112" height="893" alt="Image" src="https://github.com/user-attachments/assets/fb355260-30bd-4b34-a9de-45051364cda1" />

## 기술적 요구사항

- 클래스 간 **느슨한 결합**으로 설계하여 확장과 유지 보수가 용이하도록 해야 함.
- C#의 **객체 지향 원칙**을 최대한 지키도록 설계할 것.
- **옵저버 패턴**(델리게이트 + 이벤트) 활용할 것.
- 적 스폰은 **팩토리 패턴**을 활용할 것.
- **컬렉션은 필요와 목적에 맞게 선택**할 것.
- **LinQ는 성능이 중요한 곳에서 사용하지 말 것**.
- **전투 입력 처리는 큐**를 사용해 순차적으로 처리.
- **상수, 열거형** 등을 활용해 매직 넘버의 사용을 줄일 것.
